...
do 
    python train_style_transferV1.py --style1_dataset $dataset_folder"/3.0_3.0.h5" --style2_dataset $dataset_folder"/"$exp_name".h5" --exp_name $exp_name --exp_folder $domain_shift --epochs 100
